...
**Visual Diagrams**: See PlantUML source files in [`screenshots/`](./screenshots/):
- [`network-architecture.puml`](./screenshots/network-architecture.puml) - Complete network topology
- [`network-diagram-simple.puml`](./screenshots/network-diagram-simple.puml) - Simplified architecture view

**Generated Diagrams**:
- **Docker Swarm Architecture**: ![Docker Swarm Architecture](./screenshots/docker_swarm_architecture.png)
- **Docker Overlay Network**: ![Docker Overlay Network](./screenshots/docker_overlay_network_architecture.png)
...
All visual evidence of deployment and testing is located in [`screenshots/`](./screenshots/).

### Network Architecture Diagrams

| File | Description |
|------|-------------|
| [`docker_swarm_architecture.png`](./screenshots/docker_swarm_architecture.png) | Complete Docker Swarm cluster architecture showing manager, workers, and service distribution |
| [`docker_overlay_network_architecture.png`](./screenshots/docker_overlay_network_architecture.png) | Encrypted overlay network topology with IPsec configuration |
| [`network-architecture.puml`](./screenshots/network-architecture.puml) | PlantUML source - complete network topology |
| [`network-diagram-simple.puml`](./screenshots/network-diagram-simple.puml) | PlantUML source - simplified architecture view |

### Cluster Status and Health

| File | Description | Command Captured |
|------|-------------|------------------|
| [`cluster-nodes.png`](./screenshots/cluster-nodes.png) | 5-node cluster status (1 manager + 4 workers) | `docker node ls` |
| [`service-health.png`](./screenshots/service-health.png) | All 7 services health status | `docker service ls` |
| [`stack-services-distribution.png`](./screenshots/stack-services-distribution.png) | Service placement across nodes | `docker stack ps plant-monitoring` |

### Network Configuration

| File | Description |
|------|-------------|
| [`docker_network_inspect.txt`](./screenshots/docker_network_inspect.txt) | Complete `docker network inspect` output showing overlay network details, encryption settings, IPAM configuration, and connected containers |

> **Note**: The network inspect output is provided as a text file to avoid cluttering this README. It contains comprehensive technical details about the encrypted overlay network configuration.

### Screenshot Guidelines

For detailed instructions on capturing additional screenshots, see [`screenshots/README.md`](./screenshots/README.md).

**Key Evidence Provided**:
- ✅ Multi-node cluster topology (5 nodes)
- ✅ Service health and distribution
- ✅ Encrypted overlay network configuration
- ✅ Network architecture diagrams (PlantUML)
